    ...
    jlong kvdb_handle)
{
    ...
    (*env)->SetIntField(
        env,
        compact_status_obj,
        globals.com.micron.hse_project.hse.Kvdb.CompactStatus.sampLwm,
    ...
    (*env)->SetIntField(
        env,
        compact_status_obj,
        globals.com.micron.hse_project.hse.Kvdb.CompactStatus.sampHwm,
    ...
    (*env)->SetIntField(
        env,
        compact_status_obj,
        globals.com.micron.hse_project.hse.Kvdb.CompactStatus.sampCurr,
    ...
    (*env)->SetBooleanField(
        env,
        compact_status_obj,
        globals.com.micron.hse_project.hse.Kvdb.CompactStatus.active,
    ...
    (*env)->SetBooleanField(
        env,
        compact_status_obj,
        globals.com.micron.hse_project.hse.Kvdb.CompactStatus.canceled,
