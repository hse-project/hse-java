...
throw_new_hse_exception(JNIEnv *env, hse_err_t err)
{
    ...
    switch (ctx) {
        case HSE_ERR_CTX_NONE:
            context_obj = globals.com.micron.hse.HseException.Context.NONE;
            break;
    }
...
JNI_OnLoad(JavaVM *vm, void *reserved)
{
    ...
    local = (*env)->FindClass(env, "com/micron/hse/HseException");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.HseException.class = (*env)->NewGlobalRef(env, local);
    ...
    local = (*env)->FindClass(env, "com/micron/hse/HseException$Context");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.HseException.Context.class = (*env)->NewGlobalRef(env, local);
    ERROR_IF_REF_IS_NULL();
    ...
    local = (*env)->GetStaticObjectField(
        env, globals.com.micron.hse.HseException.Context.class, none_field);
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.HseException.Context.NONE = (*env)->NewGlobalRef(env, local);
    ERROR_IF_REF_IS_NULL();

    local = (*env)->FindClass(env, "com/micron/hse/Kvdb$CompactStatus");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.Kvdb.CompactStatus.class = (*env)->NewGlobalRef(env, local);
    ERROR_IF_REF_IS_NULL();
    globals.com.micron.hse.Kvdb.CompactStatus.sampLwm =
        (*env)->GetFieldID(env, globals.com.micron.hse.Kvdb.CompactStatus.class, "sampLwm", "I");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.Kvdb.CompactStatus.sampHwm =
        (*env)->GetFieldID(env, globals.com.micron.hse.Kvdb.CompactStatus.class, "sampHwm", "I");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.Kvdb.CompactStatus.sampCurr =
        (*env)->GetFieldID(env, globals.com.micron.hse.Kvdb.CompactStatus.class, "sampCurr", "I");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.Kvdb.CompactStatus.active =
        (*env)->GetFieldID(env, globals.com.micron.hse.Kvdb.CompactStatus.class, "active", "Z");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.Kvdb.CompactStatus.canceled =
        (*env)->GetFieldID(env, globals.com.micron.hse.Kvdb.CompactStatus.class, "canceled", "Z");
    ASSERT_NO_EXCEPTION();

    local = (*env)->FindClass(env, "com/micron/hse/KvdbTransaction$State");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.KvdbTransaction.State.class = (*env)->NewGlobalRef(env, local);
    ERROR_IF_REF_IS_NULL();

    const jfieldID aborted_field = (*env)->GetStaticFieldID(
        env,
        globals.com.micron.hse.KvdbTransaction.State.class,
        "ABORTED",
        "Lcom/micron/hse/KvdbTransaction$State;");
    ASSERT_NO_EXCEPTION();
    local = (*env)->GetStaticObjectField(
        env, globals.com.micron.hse.KvdbTransaction.State.class, aborted_field);
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.KvdbTransaction.State.ABORTED = (*env)->NewGlobalRef(env, local);;
    ERROR_IF_REF_IS_NULL();
    ...
    ASSERT_NO_EXCEPTION();
    local = (*env)->GetStaticObjectField(
        env, globals.com.micron.hse.KvdbTransaction.State.class, active_field);
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.KvdbTransaction.State.ACTIVE = (*env)->NewGlobalRef(env, local);;
    ERROR_IF_REF_IS_NULL();
    ...
    ASSERT_NO_EXCEPTION();
    local = (*env)->GetStaticObjectField(
        env, globals.com.micron.hse.KvdbTransaction.State.class, committed_field);
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.KvdbTransaction.State.COMMITTED = (*env)->NewGlobalRef(env, local);;
    ERROR_IF_REF_IS_NULL();
    ...
    ASSERT_NO_EXCEPTION();
    local = (*env)->GetStaticObjectField(
        env, globals.com.micron.hse.KvdbTransaction.State.class, invalid_field);
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.KvdbTransaction.State.INVALID = (*env)->NewGlobalRef(env, local);;
    ERROR_IF_REF_IS_NULL();

    local = (*env)->FindClass(env, "com/micron/hse/MclassInfo");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.MclassInfo.class = (*env)->NewGlobalRef(env, local);
    ERROR_IF_REF_IS_NULL();
    globals.com.micron.hse.MclassInfo.allocatedBytes =
        (*env)->GetFieldID(env, globals.com.micron.hse.MclassInfo.class, "allocatedBytes", "J");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.MclassInfo.usedBytes =
        (*env)->GetFieldID(env, globals.com.micron.hse.MclassInfo.class, "usedBytes", "J");
    ASSERT_NO_EXCEPTION();
    globals.com.micron.hse.MclassInfo.path = (*env)->GetFieldID(
        env, globals.com.micron.hse.MclassInfo.class, "path", "Ljava/nio/file/Path;");
    ASSERT_NO_EXCEPTION();
...
JNI_OnUnload(JavaVM *vm, void *reserved)
{
    ...
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.HseException.class);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.HseException.Context.class);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.HseException.Context.NONE);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.Kvdb.CompactStatus.class);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.KvdbTransaction.State.class);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.KvdbTransaction.State.ABORTED);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.KvdbTransaction.State.ACTIVE);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.KvdbTransaction.State.COMMITTED);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.KvdbTransaction.State.INVALID);
    (*env)->DeleteGlobalRef(env, globals.com.micron.hse.MclassInfo.class);
